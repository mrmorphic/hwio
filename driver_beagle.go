...
func init() {
	...
	p := []*BeaglePin{
		...
		&BeaglePin{"",	"GPIO0_7",	GPIO0,		1<<7,	"ecap0_in_pwm0_out"},
		&BeaglePin{"",	"GPIO0_26",	GPIO0,		1<<26,	"gpmc_ad10"},
		&BeaglePin{"",	"GPIO0_27",	GPIO0,		1<<27,	"gpmc_ad11"},
		&BeaglePin{"",	"GPIO1_0",	GPIO1,		1,		"gpmc_ad0"},
		&BeaglePin{"",	"GPIO1_1",	GPIO1,		1<<1,	"gpmc_ad1"},
		&BeaglePin{"",	"GPIO1_2",	GPIO1,		1<<2,	"gpmc_ad2"},
		&BeaglePin{"",	"GPIO1_3",	GPIO1,		1<<3,	"gpmc_ad3"},
		&BeaglePin{"",	"GPIO1_4",	GPIO1,		1<<4,	"gpmc_ad4"},
		&BeaglePin{"",	"GPIO1_5",	GPIO1,		1<<5,	"gpmc_ad5"},
		&BeaglePin{"",	"GPIO1_6",	GPIO1,		1<<6,	"gpmc_ad6"},
		&BeaglePin{"",	"GPIO1_7",	GPIO1,		1<<7,	"gpmc_ad7"},
		&BeaglePin{"",	"GPIO1_12",	GPIO1,		1<<12,	"gpmc_ad12"},
		&BeaglePin{"",	"GPIO1_13",	GPIO1,		1<<13,	"gpmc_ad13"},
		&BeaglePin{"",	"GPIO1_14",	GPIO1,		1<<14,	"gpmc_ad14"},
		&BeaglePin{"",	"GPIO1_15",	GPIO1,		1<<15,	"gpmc_ad15"},
		&BeaglePin{"",	"GPIO1_16",	GPIO1,		1<<16,	"gpmc_a0"},
		&BeaglePin{"",	"GPIO1_17",	GPIO1,		1<<17,	"gpmc_a1"},
		&BeaglePin{"",	"GPIO1_28",	GPIO1,		1<<28,	"gpmc_ben1"},
		&BeaglePin{"",	"GPIO1_29",	GPIO1,		1<<29,	"gpmc_csn0"},
		&BeaglePin{"",	"GPIO1_30",	GPIO1,		1<<30,	"gpmc_csn1"},
		&BeaglePin{"",	"GPIO1_31",	GPIO1,		1<<31,	"gpmc_csn2"},
		&BeaglePin{"",	"GPIO2_1",	GPIO2,		1,		"gpmc_clk"},
		&BeaglePin{"",	"GPIO2_6",	GPIO2,		1<<6,	"lcd_data0"},
		&BeaglePin{"",	"GPIO2_7",	GPIO2,		1<<7,	"lcd_data1"},
		&BeaglePin{"",	"GPIO2_8",	GPIO2,		1<<8,	"lcd_data2"},
		&BeaglePin{"",	"GPIO2_9",	GPIO2,		1<<9,	"lcd_data3"},
		&BeaglePin{"",	"GPIO2_10",	GPIO2,		1<<10,	"lcd_data4"},
		&BeaglePin{"",	"GPIO2_11",	GPIO2,		1<<11,	"lcd_data5"},
		&BeaglePin{"",	"GPIO2_12",	GPIO2,		1<<12,	"lcd_data6"},
		&BeaglePin{"",	"GPIO2_13",	GPIO2,		1<<13,	"lcd_data7"},
		&BeaglePin{"",	"GPIO2_22",	GPIO2,		1<<22,	"lcd_vsync"},
		&BeaglePin{"",	"GPIO2_23",	GPIO2,		1<<23,	"lcd_hsync"},
		&BeaglePin{"",	"GPIO2_24",	GPIO2,		1<<24,	"lcd_pclk"},
		&BeaglePin{"",	"GPIO2_25",	GPIO2,		1<<25,	"lcd_ac_bias_en"},
		&BeaglePin{"",	"GPIO3_19",	GPIO3,		1<<19,	"mcasp0_fsr"},
		&BeaglePin{"",	"GPIO3_21",	GPIO3,		1<<21,	"mcasp0_ahclkx"},
	}
	beaglePins = p
}
