...
func (c Capability) String() string {
	switch c {
		case CAP_INPUT: return "input"
		case CAP_OUTPUT: return "output"
		case CAP_INPUT_PULLUP: return "input_pullup"
		case CAP_PWM: return "pwm"
		case CAP_ANALOG_IN: return "analog_in"
	}
	return ""
}
